...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_App2.default, { initialSetup: _config2.default.initialSetup }), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function App(_ref) {
	  var initialSetup = _ref.initialSetup;

	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_Board2.default, { initialSetup: initialSetup })
	  );
	};

	App.propTypes = {
	  initialSetup: _react2.default.PropTypes.array.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Notice = __webpack_require__(180);

	var _Notice2 = _interopRequireDefault(_Notice);

	var _Command = __webpack_require__(181);

	var _Command2 = _interopRequireDefault(_Command);

	var _PieceList = __webpack_require__(182);
	...
	var Board = function (_React$Component) {
	  ...
	  function Board(props) {
	    ...
	    _this.deletePiece = _this.deletePiece.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Board, [{
	    ...
	    value: function initBoard() {
	      ...
	      for (var counter = 0, _i = 0; _i < 8; _i++) {
	        for (var j = 0; j < 8; j++) {
	          var square = {
	            index: counter,
	            chessId: String(colNames[j] + (8 - _i)),
	            row: _i,
	            col: j,
	            piece: null
	          };
	    ...
	    value: function initPieces() {
	      ...
	      var squares = _state2.squares;
	      var pieces = _state2.pieces;


	      this.props.initialSetup.forEach(function (item) {
	        var piece = {
	          location: item[0],
	          type: item[1],
	          owner: item[2],
	    ...
	    key: 'handleMove',
	    value: function handleMove(index) {
	      var _state3 = this.state;
	      var squares = _state3.squares;
	      var rows = _state3.rows;
	      var cols = _state3.cols;
	      var moveInProgress = _state3.moveInProgress;
	      var movingPiece = _state3.movingPiece;
	      var validMoves = _state3.validMoves;
	      var currentPlayer = _state3.currentPlayer;

	      var target = squares[index];
	      ...
	      // if !moveInProgress, treat click as initiating move
	          ...
	          var _validMoves = this.refs[target.index].refs.piece.determineValidMoves(target, squares, rows, cols, currentPlayer);
	          ...
	          if (!_validMoves.length) {
	            return this.cancelMove(NOTICE_TYPE.noMovesAvailable); // no valid moves were found...
	              ...
	              this.setState({ validMoves: _validMoves });
	            }
	        }
	    }
	  }, {
	    key: 'completeMove',
	    value: function completeMove(index) {
	      var movingPiece = arguments.length <= 1 || arguments[1] === undefined ? this.state.movingPiece : arguments[1];
	      var _state4 = this.state;
	      var squares = _state4.squares;
	      var pieces = _state4.pieces;
	      var currentPlayer = _state4.currentPlayer;

	      // remove piece from old location

	      var source = squares[movingPiece.location];
	      source.piece = null;

	      // access new location and remove eliminated enemy piece, if needed
	      var destination = squares[index];
	      ...
	      this.setState({ squares: (0, _reactAddonsUpdate2.default)(squares, _defineProperty({}, source.index, { $set: source })) });
	      this.setState({ squares: (0, _reactAddonsUpdate2.default)(squares, _defineProperty({}, destination.index, { $set: destination })) });
	    ...
	    key: 'cancelMove',
	    value: function cancelMove(notice) {
	      var _this2 = this;
	      ...
	      notices = (0, _reactAddonsUpdate2.default)(this.state.notices, _defineProperty({}, notice, { $set: true }));
	      this.setState({ notices: notices }, function () {
	        setTimeout(function () {
	          notices = (0, _reactAddonsUpdate2.default)(_this2.state.notices, _defineProperty({}, notice, { $set: false }));
	    ...
	    value: function handleCommand(command) {
	      ...
	      var pieces = _state5.pieces;
	      var squares = _state5.squares;
	      var rows = _state5.rows;
	      var cols = _state5.cols;
	      var currentPlayer = _state5.currentPlayer;
	      ...
	      var pieceId = command.substr(0, 3);
	      var chessId = command.substr(3);
	      ...
	      var source = squares[piece.location];
	      var destination = squares.find(function (square) {
	        return square.chessId === chessId;
	      });
	      if (!destination) return this.cancelMove(NOTICE_TYPE.invalidCommand);

	      // get valid moves
	      var validMoves = this.refs[source.index].refs.piece.determineValidMoves(source, squares, rows, cols, currentPlayer);
	    ...
	    key: 'deletePiece',
	    value: function deletePiece(pieceId, index) {
	    ...
	    value: function render() {
	      ...
	      var squares = this.state.squares.map(function (square, index) {
	        return _react2.default.createElement(_Square2.default, {
	          ...
	          piece: square.piece,
	          handleMove: _this3.handleMove,
	          deletePiece: _this3.deletePiece
	        });
	      });
	      ...
	      var rows = [];
	      var chunk = 8;
	      for (var i = 0; i < squares.length; i += chunk) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_Notice2.default, { notices: this.state.notices })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'sidebar' },
	            _react2.default.createElement(_Command2.default, { handleCommand: this.handleCommand }),
	            _react2.default.createElement(_PieceList2.default, { pieces: this.state.pieces })
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var chessPieces = {
	  King: _King2.default, Queen: _Queen2.default, Bishop: _Bishop2.default, Knight: _Knight2.default, Rook: _Rook2.default, Pawn: _Pawn2.default
	};
	...
	var Square = function (_React$Component) {
	  ...
	  function Square(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Square).call(this, props));
	  ...
	  _createClass(Square, [{
	    ...
	    value: function render() {
	      ...
	      var chessId = _props.chessId;
	      var handleMove = _props.handleMove;


	      piece = piece ? _react2.default.createElement(chessPieces[piece.type], { ref: 'piece', type: piece.type, owner: piece.owner }) : '';

	      var form = this.state.showDelete && piece ? _react2.default.createElement(
	        'form',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { type: 'button', onClick: this.cancelDelete },
	            'No'
	          )
	        )
	      ) : '';
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'square', onClick: handleMove.bind(this, index) },
	        _react2.default.createElement(
	          'div',
	          ...
	          piece ? _react2.default.createElement('span', { className: 'delete-label', onClick: this.startDelete }) : ''
	        ),
	        piece,
	        form
	      );
	...
	Square.propTypes = {
	  chessId: _react2.default.PropTypes.string.isRequired,
	  piece: _react2.default.PropTypes.object,
	  handleMove: _react2.default.PropTypes.func.isRequired,
	  deletePiece: _react2.default.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChessPiece2 = __webpack_require__(174);

	var _ChessPiece3 = _interopRequireDefault(_ChessPiece2);
	...
	var King = function (_ChessPiece) {
	  _inherits(King, _ChessPiece);
	  ...
	  _createClass(King, [{
	    key: 'determineValidMoves',
	    value: function determineValidMoves(start, squares, rows, cols, currentPlayer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChessPiece = function (_React$Component) {
	  ...
	  _createClass(ChessPiece, [{
	    ...
	    value: function moveDiagonal(start, diagonal, direction, currentPlayer) {
	      var validMoves = [];
	    ...
	    key: "moveHorizontalAndVertical",
	    value: function moveHorizontalAndVertical(start, rows, cols, currentPlayer) {
	      var validMoves = [];

	      // make horizontal slices and reverse first so arrays "radiate" out from start position
	      var slice1 = rows[start.row].slice(0, start.col).reverse();
	      var slice2 = rows[start.row].slice(start.col + 1);

	      // make vertical slices and reverse first so arrays "radiate" out from start position
	      var slice3 = cols[start.col].slice(0, start.row).reverse();
	      var slice4 = cols[start.col].slice(start.row + 1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Queen = function (_ChessPiece) {
	  _inherits(Queen, _ChessPiece);
	  ...
	  _createClass(Queen, [{
	    ...
	    value: function determineValidMoves(start, squares, rows, cols, currentPlayer) {
	      ...
	      var topLeft = this.moveDiagonal(start, start.topLeft, 'topLeft', currentPlayer);
	      var topRight = this.moveDiagonal(start, start.topRight, 'topRight', currentPlayer);
	      var bottomLeft = this.moveDiagonal(start, start.bottomLeft, 'bottomLeft', currentPlayer);
	      var bottomRight = this.moveDiagonal(start, start.bottomRight, 'bottomRight', currentPlayer);

	      var validMoves = this.moveHorizontalAndVertical(start, rows, cols, currentPlayer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bishop = function (_ChessPiece) {
	  _inherits(Bishop, _ChessPiece);
	  ...
	  _createClass(Bishop, [{
	    ...
	    value: function determineValidMoves(start, squares, rows, cols, currentPlayer) {
	      ...
	      var validMoves = Array.prototype.concat(topLeft, topRight, bottomLeft, bottomRight);
	      return validMoves;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Knight = function (_ChessPiece) {
	  _inherits(Knight, _ChessPiece);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pawn = function (_ChessPiece) {
	  _inherits(Pawn, _ChessPiece);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Notice.propTypes = {
	  notices: _react2.default.PropTypes.object.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Command = function (_React$Component) {
	  ...
	  function Command(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Command).call(this, props));
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'Click on the desired piece and then click on the destination tile.'
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
	          'Alternatively, you can enter a chess notation command below.'
	        ),
	        _react2.default.createElement(
	          'form',
	        ...
	        _react2.default.createElement(
	          ...
	          ' moves White\'s Horse #1 (Knight) to tile C3'
	        )
	      );
	    }
	  }]);
	...
	Command.propTypes = {
	  handleCommand: _react2.default.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PieceList = function PieceList(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'tbody',
	        null,
	        Object.keys(whitePieces).sort().map(function (key, index) {
	          return _react2.default.createElement(
	            'tr',
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'tbody',
	        null,
	        Object.keys(blackPieces).sort().map(function (key, index) {
	          return _react2.default.createElement(
	            'tr',
	            { className: 'item', key: index },
	            _react2.default.createElement(
	...
	PieceList.propTypes = {
	  pieces: _react2.default.PropTypes.object.isRequired
	};
